    ...
    return (
        <div>
            ...
            <div className={"ButtonRow"}>
                ...
                <button>Commencer le classement</button>
                <button>Reprendre le classement</button>
                <button>Exporter tous les personnages</button>
                <button>Générer les commandes de tri</button>
                <button>Effacer la sortie</button>
